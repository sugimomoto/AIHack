...
そのために解くべき問題を、ひとつに絞りました。
**養育費が決まらない。面会交流が続かない。**——どちらも、**親同士の連絡が持たない**ことで起きています。

だから Aida は、**親同士が直接やりとりせずに、取り決めができる**ようにします。
養育費・面会交流などを決め、公正証書のドラフトまで組み立てます。

★ ただし、**公正証書を作ることが目的ではありません。**

| | |
| --- | --- |
| 目的 | ★**子どもの生活基盤が守られ、親に会えること** |
| 手段 | 親同士が**直接やりとりせずに**合意できるようにすること |
| 道具 | 取り決めの記録、公正証書のドラフト |
| 直接の受益者 | 父母（連絡の負担が減る） |
| ★**本来の受益者** | ★**子ども** |

そして、そのために実際にやっていることは、**伝えること**です。
...
私は離婚の当事者ではありません。**国の調査を読んで、解くべき場所が決まりました。**

```
① 離婚の 87.5% は協議離婚。裁判所も代理人も介在しない
...
★ ③が要点です。**お金がないからでも、制度を知らないからでもありません。**

> **相手と関わりたくないから、取り決めが結ばれない。**
> その結果、**子どもの生活費が決まらない。**

言い換えると、**話し合いが決裂しているのではありません。始まってすらいない。**
伝えたいことが無いのではなく、**伝える手段のほうが持たない**のです。

★ そして、そのしわ寄せを受けるのは**子ども**です。

- 取り決めが無ければ、**月2万円（子1人）**しか請求できません
  （取り決めのある世帯の平均は **月50,485円**）
- 連絡が続かなければ、**会えなくなります**

**親同士の連絡の問題が、そのまま子どもの生活と関係の問題になっています。**
だから「親のコミュニケーションを楽にすること」は、**目的ではなく手段**です。

面会交流も同じでした。会いたくないからではなく、**連絡したくないから**続きません。

そして②が言っているのは、**あいだに誰かが入れば決まる**ということです。
ただし裁判所も弁護士も、**87.5%の協議離婚には入ってきません**（費用は双方で60〜100万円）。

★ **「あいだに入る第三者」を、非同期・24時間・低単価で成立させる。**
これが、このプロダクトが解こうとした問題です。
