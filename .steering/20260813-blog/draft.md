...
> ★ **不満を抱えたままでも、子育ての実務が回るようにすること。**

これがゴールです。関係を修復する道具ではありません。
**修復しないまま、必要なことだけが決まっていく**ようにする道具です。
...
日本の離婚の **87.5% は協議離婚**で、裁判所も代理人も介在しません。
その **43.6%** しか養育費の取り決めをしておらず（裁判所を経れば **81.2%**）、
取り決めをしない理由の**第1位は「相手と関わりたくない」**でした。

★ **あいだに誰かが入れば決まる。**
けれど裁判所も弁護士も、協議離婚には入ってきません（双方で60〜100万円かかります）。

> **「あいだに入る第三者」を、非同期・24時間・低単価で成立させる。**

それを、**決める段階だけでなく、そのあとの日々にも効く形で**やる、というのが Aida です。
