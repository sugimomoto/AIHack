...
離婚する／した父母が、**互いに一度もメッセージを送り合わないまま**、
養育費や面会交流の取り決めをして、**公正証書のドラフトまで到達できる**アプリです。
...
私は離婚の当事者ではありません。**国の調査を読んで、作るものが決まりました。**
...
| ★Aida | 人 ⇄ **AI** ⇄ 人（**AIは、通す／通さないを決める門**） |

そして門の性質が、**このプロダクトの全部**です。
...
★ **拒否すると、書いた人は行き場を失います。**
Aida は受け止めたうえで、**相手に渡すものだけを組み立て直します。**
...
父はAIと話し、母もAIと話します。**書いた言葉そのものは、決して相手に届きません。**
**合意に必要な事実だけが、伝聞のかたちで越えます。**（挙動は冒頭のとおり）
